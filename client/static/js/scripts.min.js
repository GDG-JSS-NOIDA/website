...
jQuery(function($) {
  ...
  $(window).load(function() {
    ...
    $portfolio_selectors.on("click", function() {
      ...
      if (selector == ".upcoming" || ".ongoing") {
		if ( !$portfolio.data('isotope').$filteredAtoms.length ) {
		  $("#portfolio_text").html("More events coming. Keep checking.");
		}
      }
      return false;
    });
  ...
  // smooth scroll
	$("a.explore[href^=\\#]").on('click', function(e) {
